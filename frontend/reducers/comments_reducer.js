...
//   // console.log(action)
//   // if (state.rootComments) {Object.freeze(state.rootComments)}
//   // if (state.replies) {Object.freeze(state.replies)}
//   Object.freeze(state);
//   let nextState = {};
//   let comments = null;
...
import rootCommentsReducer from './rootComments_reducer';

const commentsReducer = combineReducers({
  replies: repliesReducer,
  rootComments: rootCommentsReducer,
});
